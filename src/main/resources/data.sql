INSERT IGNORE INTO CATEGORIA(id, nome) values(1,'Brinquedo') ;
INSERT IGNORE INTO CATEGORIA(id, nome) values(2,'Eletrônicos') ;
INSERT IGNORE INTO CATEGORIA(id, nome) values(3,'Bigodes Falsos') ; 
